...
FILE: CC2511_USB_DONGLE_Reference_Design_1_3.ZIP PACKED WITH WinZIP V.9.0 
...
-------------------------------------------------------------------------------------------
CC2511_USB_DONGLE_REFERENCE_DESIGN_README_1_3.TXT      THIS FILE            	ASCII
...
DRILL.SPL         		DRILL/MECHANICAL DRAWING                  	EXT. GERBER/PDF
DRILL.REP			DRILL REPORT					ASCII
EXT_GERBER.USR	     		EXTENDED GERBER APERTURE TABLE 			ASCII
CNC.USR		     		NC DRILL DEVICE FILE				ASCII			

CC2511_USB_Dongle_layout_1_3	ALL LAYERS					PDF

IFA_USB.SPL			PCB ANTENNA					EXT. GERBER
IFA_USB.DXF			PCB ANTENNA					EXT. GERBER

P&PCOMP.REP			PICK AND PLACE COMP SIDE			ASCII
P&PSOLD.REP			PICK AND PLACE SOLD SIDE			ASCII

***PCB ASSEMBLY FILES:
ASSYCOMP.SPL       		ASSEMBLY DRAWING COMPONENT SIDE           	EXT. GERBER
ASSYSOLD.SPL			ASSEMBLY DRAWING SOLDER SIDE			EXT. GERBER
Partlist.rep			PARTLIST					ASCII	
BOM.rep				BILL OF MATERIALS				ASCII
CC2511_USB_Dongle_schematic_1_3.pdf
				CIRCUIT DIAGRAM 				PDF

***DESIGN FILES:
CC2511_dongle_1_3.scm	CADSTAR SCHEMATIC FILE					BINARY
CC2511_dongle_1_3.csa	CADSTAR SCHEMATIC FILE					ASCII
CC2511_dongle_1_3.pcb  	CADSTAR WORK FILE  (PCB)                  		BINARY
CC2511_dongle_1_3.cpa  	CADSTAR WORK FILE  (PCB)                  		ASCII
